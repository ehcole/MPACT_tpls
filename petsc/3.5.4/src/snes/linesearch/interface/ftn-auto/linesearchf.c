...
PETSC_EXTERN void PETSC_STDCALL  sneslinesearchgetsuccess_(SNESLineSearch linesearch,PetscBool *success, int *__ierr ){
*__ierr = SNESLineSearchGetSuccess(
	(SNESLineSearch)PetscToPointer((linesearch) ),success);
}
PETSC_EXTERN void PETSC_STDCALL  sneslinesearchsetsuccess_(SNESLineSearch linesearch,PetscBool *success, int *__ierr ){
