...
PETSC_EXTERN void PETSC_STDCALL  matgetrowmin_(Mat mat,Vec v,PetscInt idx[], int *__ierr ){
*__ierr = MatGetRowMin(
	(Mat)PetscToPointer((mat) ),
	(Vec)PetscToPointer((v) ),idx);
}
PETSC_EXTERN void PETSC_STDCALL  matgetrowminabs_(Mat mat,Vec v,PetscInt idx[], int *__ierr ){
*__ierr = MatGetRowMinAbs(
	(Mat)PetscToPointer((mat) ),
	(Vec)PetscToPointer((v) ),idx);
}
PETSC_EXTERN void PETSC_STDCALL  matgetrowmax_(Mat mat,Vec v,PetscInt idx[], int *__ierr ){
*__ierr = MatGetRowMax(
	(Mat)PetscToPointer((mat) ),
	(Vec)PetscToPointer((v) ),idx);
}
PETSC_EXTERN void PETSC_STDCALL  matgetrowmaxabs_(Mat mat,Vec v,PetscInt idx[], int *__ierr ){
