...
PETSC_EXTERN void PETSC_STDCALL  matcoarsensetverbose_(MatCoarsen agg,PetscInt *vv, int *__ierr ){
*__ierr = MatCoarsenSetVerbose(
	(MatCoarsen)PetscToPointer((agg) ),*vv);
}
