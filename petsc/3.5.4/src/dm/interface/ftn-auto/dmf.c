...
PETSC_EXTERN void PETSC_STDCALL  dmcreateinjection_(DM dm1,DM dm2,VecScatter *ctx, int *__ierr ){
...
PETSC_EXTERN void PETSC_STDCALL  dmsetcoordinatesection_(DM dm,PetscSection section, int *__ierr ){
