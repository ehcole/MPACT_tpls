...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  pcjacobisetuseabs_(PC pc, int *__ierr ){
*__ierr = PCJacobiSetUseAbs(
	(PC)PetscToPointer((pc) ));
}
PETSC_EXTERN void PETSC_STDCALL  pcjacobisetuserowmax_(PC pc, int *__ierr ){
*__ierr = PCJacobiSetUseRowMax(
	(PC)PetscToPointer((pc) ));
}
PETSC_EXTERN void PETSC_STDCALL  pcjacobisetuserowsum_(PC pc, int *__ierr ){
