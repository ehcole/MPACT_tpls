...
PETSC_EXTERN void PETSC_STDCALL  kspsetnullspace_(KSP ksp,MatNullSpace nullsp, int *__ierr ){
*__ierr = KSPSetNullSpace(
	(KSP)PetscToPointer((ksp) ),
	(MatNullSpace)PetscToPointer((nullsp) ));
}
PETSC_EXTERN void PETSC_STDCALL  kspgetnullspace_(KSP ksp,MatNullSpace *nullsp, int *__ierr ){
