...
ELSEIF ( ZLIB_SRC_DIR )
    ...
    SET( ZLIB_CMAKE_INSTALL_DIR "${CMAKE_INSTALL_PREFIX}/common/zlib-${ZLIB_VERSION}" )
    SET( CMAKE_BUILD_ZLIB TRUE )
...
IF ( CMAKE_BUILD_ZLIB ) 
    EXTERNALPROJECT_ADD(
        ...
        CMAKE_ARGS          "${CMAKE_ARGS};-DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}/common/zlib-${ZLIB_VERSION}"
