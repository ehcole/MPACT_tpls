...
IF ( CMAKE_BUILD_HYPRE )
    ...
    LIST(APPEND CONFIGURE_OPTIONS --with-blas-lib-dirs=${BLAS_DIR} )
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --with-lapack-libs=${LAPACK_LIB_NAMES} )
    ...
    ELSE()
        SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} )
    ENDIF()
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} CC=mpicc CXX=mpicxx FC=mpif90 F77=mpif77 F90=mpif90 )
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} "CFLAGS=-fPIC -fopenmp" )
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} "CXXFLAGS=-fPIC -fopenmp" )
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} "FFLAGS=-fopenmp" )
ENDIF()
