...
IF ( HDF5_URL ) 
    ...
    SET( HDF5_CMAKE_INSTALL_DIR "${CMAKE_INSTALL_PREFIX}/vera_cs/hdf5-${HDF5_VERSION}" )
...
IF ( CMAKE_BUILD_HDF5 )
    EXTERNALPROJECT_ADD(
        ...
        UPDATE_COMMAND      ""
        CONFIGURE_COMMAND   ${HDF5_CMAKE_SOURCE_DIR}/configure --prefix=${CMAKE_INSTALL_PREFIX}/vera_cs/hdf5-${HDF5_VERSION} ${CONFIGURE_OPTIONS} ${ENV_SERIAL_VARS}
