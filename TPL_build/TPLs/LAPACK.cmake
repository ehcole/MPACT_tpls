...
IF ( LAPACK_URL ) 
    ...
    SET( LAPACK_CMAKE_INSTALL_DIR "${CMAKE_INSTALL_PREFIX}/common/lapack-${LAPACK_VERSION}" )
...
IF ( CMAKE_BUILD_LAPACK ) 
    EXTERNALPROJECT_ADD(
        ...
        CMAKE_ARGS          "${CMAKE_ARGS};-DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}/common/lapack-${LAPACK_VERSION}"
