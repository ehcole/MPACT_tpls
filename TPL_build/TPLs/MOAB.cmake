...
IF ( MOAB_URL ) 
    ...
    SET( MOAB_CMAKE_INSTALL_DIR "${CMAKE_INSTALL_PREFIX}/moab-${MOAB_VERSION}" )
...
IF ( CMAKE_BUILD_MOAB )
    EXTERNALPROJECT_ADD(
        ...
        UPDATE_COMMAND      ""
        CONFIGURE_COMMAND   ${MOAB_SRC_DIR}/configure --prefix=${CMAKE_INSTALL_PREFIX}/moab-${MOAB_VERSION} ${CONFIGURE_OPTIONS} ${ENV_SERIAL_VARS}
