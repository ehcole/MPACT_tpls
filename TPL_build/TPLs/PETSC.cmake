...
IF ( CMAKE_BUILD_PETSC )
    ...
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --with-hypre-dir=${CMAKE_INSTALL_PREFIX}/hypre )    
    ...
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --CFLAGS=${CMAKE_C_FLAGS} )
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --CXXFLAGS=${CMAKE_CXX_FLAGS} )
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --FCFLAGS=${CMAKE_Fortran_FLAGS} )
