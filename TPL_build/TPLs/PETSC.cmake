...
ENDIF()
#SET( CONFIGURE_OPTIONS --PETSC_ARCH= --PETSC_DIR=${CMAKE_BINARY_DIR}/PETSC-prefix/src/PETSC-build )
SET( CONFIGURE_OPTIONS --PETSC_ARCH=${PETSC_ARCH} --PETSC_DIR=${PETSC_SRC_DIR} )
...
SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --with-clanguage=c++ --with-x=false --with-x11=false )
SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --download-ml=${ML_TAR} ${BUILD_OPTS} )
