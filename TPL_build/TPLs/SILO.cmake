...
IF ( SILO_URL ) 
    ...
    SET( SILO_CMAKE_INSTALL_DIR "${CMAKE_INSTALL_PREFIX}/vera_cs/silo-${SILO_VERSION}" )
...
IF ( CMAKE_BUILD_SILO )
    ...
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --prefix=${CMAKE_INSTALL_PREFIX}/vera_cs/silo-${SILO_VERSION}  )
